...
(function ($) {
    ...
    TimeSlider.prototype.add_events = function() {
        ...
        // for mobile
        document.getElementById("slider123").addEventListener("touchstart", function(e) {
            _this.prev_cursor_x = e.touches[0].clientX
        })
        document.getElementById("slider123").addEventListener("touchmove", function(e) {
            var pos_x = Math.round(e.touches[0].clientX);
    ...
    TimeSlider.prototype.get_time = function() {
        genEvent(this.options.start_timestamp);
    }
    ...
    async function Plugin(options, timecell) {
        return await this.each(function() {
            var _this = $(this);
